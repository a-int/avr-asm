...
tc0_init:
	...
	out TCNT0, r16
	ldi r16, 0xF9; запись числа 249(10) в OCR0
	out OCR0, r16
	ldi r20, 0x28; счетчик совпадений T/C0
	ldi r16, 0b00001010; запуск Т/С0 в режиме СТС и предделителем 8
	out TCCR0, r16
	ldi r16, 0b00000010; разрешение прерывания по совпадению T/C0 и OCR0
	out TIMSK, r16
